...
| backend.environment.viewUnsafeMode | bool | `false` | When true, `/view` may fetch remote credential/status/OCA URLs (`VIEW_UNSAFE_MODE`; SSRF risk — keep false in prod) |
