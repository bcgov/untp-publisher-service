...
|---------|-----------|--------|
| `deploy/dev/values.yaml` | `f890b1-dev` | Shared with `tests-untp-ri`. Quota: [tests-untp `f890b1-dev-quota.md`](https://github.com/bcgov/tests-untp/blob/charts/deploy/f890b1-dev-quota.md). Image **`dev-0.0.4`** includes landing + Discovery UI. |
| `deploy/test/values.yaml` | `f890b1-test` | Traction/WebVH **test** (image tag unchanged until UI rollout) |
| `deploy/prod/values.yaml` | `f890b1-prod` | Traction/WebVH **prod** (image tag unchanged until UI rollout) |
