...
|---------|-----------|--------|
| `deploy/dev/values.yaml` | `f890b1-dev` | Shared with `tests-untp-ri`. Quota: [tests-untp `f890b1-dev-quota.md`](https://github.com/bcgov/tests-untp/blob/charts/deploy/f890b1-dev-quota.md). Image **[`v0.2.0`](https://github.com/bcgov/untp-publisher-service/releases/tag/v0.2.0)** + NRS CRM landing branding. |
| `deploy/test/values.yaml` | `f890b1-test` | Traction/WebVH **test**. Image **[`v0.2.0`](https://github.com/bcgov/untp-publisher-service/releases/tag/v0.2.0)** + NRS CRM landing branding. |
| `deploy/prod/values.yaml` | `f890b1-prod` | Traction/WebVH **prod**. Image **[`v0.2.0`](https://github.com/bcgov/untp-publisher-service/releases/tag/v0.2.0)** + NRS CRM landing branding. |
