...
ADMIN_COLLECTIONS: dict[str, dict[str, Any]] = {
    ...
    "StatusListRecord": {
        ...
        "create_via": "Startup provisioning (3 active lists per issuer) and POST /registrations/credentials",
        "prerequisites": ["Issuer listed in configs/issuers.yaml (or credential type registration)"],
        "next_steps": [],
        "id_field": "id",
